...
public class CatalogInitializer {
	...
	public static List<CatalogItem> createCatalog() {
		...
		int articleNumber = 479239;//new Random().nextInt(100000);
		...
		catalog.add(new CatalogItem(Integer.toString(articleNumber++), "Krem'o'rama", "This chocolate creme is without any natural ingrediants, quite perfect for allergic subjects", 4.54));
